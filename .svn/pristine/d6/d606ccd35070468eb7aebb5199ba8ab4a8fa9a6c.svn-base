	                   ...
	                   <c:if test="${kcList != null}">
		                <c:forEach var="kc" items="${kcList}" varStatus="vs">
		                    <div class="kcs-list">
		                      ...
		                      <input style="display:none" class="kcs-id" id="kcId${vs.index}" value="${kc.kcId}"></input>
		                      <input class="kcs-title" id="title${vs.index}" value="${kc.title}" maxlength="25" ></input>
		                      <input class="kcs-order" id="orderId${vs.index}" value="${kc.orderId}" maxlength="3" ></input>
		                      <c:choose>
		                       <c:when test="${kc.status == 0}">
		                          <select id="status${vs.index}" class="kcs-status">
