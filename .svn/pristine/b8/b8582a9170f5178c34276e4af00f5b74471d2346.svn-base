...
// 返回到课程Top
var backToKCTop = function() {
	var kcId = $.cookie('KSXT-KC-ID-D17-M02-Y17');
	document.getElementById('back').href="/kecheng/view?kcId=" + kcId;
}

// 返回到试卷List
var backToSJList = function() {
	var kcId = $.cookie('KSXT-KC-ID-D17-M02-Y17');
	document.getElementById('back').href="/kaoshi/shijuan/list?kcId=" + kcId;
}